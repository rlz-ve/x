              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-white/10">
                    <th className="py-4 px-6 text-left text-sm font-medium text-gray-400">Method</th>
                    <th className="py-4 px-6 text-left text-sm font-medium text-gray-400">Description</th>
                    <th className="py-4 px-6 text-left text-sm font-medium text-gray-400">Address</th>
                  </tr>
                </thead>
                <tbody>
                  {methods.map((method, index) => (
                    ...
                    >
                      ...
                      <td className="py-4 px-6 text-gray-400">{method.desc}</td>
                      <td className="py-4 px-6">
                        <motion.button
                          onClick={() => handleCopy(method.value, method.title)}
                          className="group/btn flex items-center justify-between w-full max-w-xs bg-white/5 px-4 py-2 rounded-lg hover:bg-white/10 transition-colors"
